...
| **العربية** | 🚧 قيد الإنشاء — ٤٧ ملاحظة | راجع [خريطة المحتوى](_Noetix/خريطة%20المحتوى.md) |
...
| **DRF في الإنتاج — ١٣** | [قائمة جاهزية الإنتاج](19.DRF%20في%20الإنتاج/0.قائمة%20جاهزية%20الإنتاج.md) · التقسيم · تحديد المعدّل · التخزين المؤقّت · [مشكلة N+1](19.DRF%20في%20الإنتاج/4.مشكلة%20N+1.md) · الصلاحيات المخصّصة · Token/JWT/Session · الإشارات · المعاملات · Celery · [تدقيق الأمان](19.DRF%20في%20الإنتاج/10.قائمة%20تدقيق%20الأمان.md) · التسجيل · الإصدارات |
| **أساسيات Django** | [الجديد في Django 6.1](22.أساسيات%20Django/1.الجديد%20في%20Django%206.1.md) |

**الطبقات الثلاث المكتملة — المفاهيم والمرجع والإنتاج — هي ما يُفتَح ويُبحَث فيه مرارًا.** المفاهيم المتبقّية بالإنجليزية ثانوية، ومُدرَجة في فهرس المفاهيم مع روابطها.

### ⬜ الترتيب القادم

1. أقسام الدورة ١–١٦ (تُقرأ مرة واحدة مع الفيديو — أقلّ عائدًا للترجمة)
2. بقيّة أساسيات Django (القسم ٢٢)
